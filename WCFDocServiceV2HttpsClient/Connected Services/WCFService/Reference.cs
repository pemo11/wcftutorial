...
namespace WCFDocServiceV2HttpsClient.WCFService {
    ...
    public partial class Document : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private WCFDocServiceV2HttpsClient.WCFService.MediaType MediaIdField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public WCFDocServiceV2HttpsClient.WCFService.MediaType MediaId {
            get {
    ...
    public interface IDocumentService {
        ...
        WCFDocServiceV2HttpsClient.WCFService.Document[] GetDocuments();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://wcf/documents/IDocumentService/GetDocuments", ReplyAction="http://wcf/documents/IDocumentService/GetDocumentsResponse")]
        System.Threading.Tasks.Task<WCFDocServiceV2HttpsClient.WCFService.Document[]> GetDocumentsAsync();
        ...
        WCFDocServiceV2HttpsClient.WCFService.Document GetDocument(int DocId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://wcf/documents/IDocumentService/GetDocument", ReplyAction="http://wcf/documents/IDocumentService/GetDocumentResponse")]
        System.Threading.Tasks.Task<WCFDocServiceV2HttpsClient.WCFService.Document> GetDocumentAsync(int DocId);
        ...
        WCFDocServiceV2HttpsClient.WCFService.Document[] SearchDocuments(string Filter);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://wcf/documents/IDocumentService/SearchDocuments", ReplyAction="http://wcf/documents/IDocumentService/SearchDocumentsResponse")]
        System.Threading.Tasks.Task<WCFDocServiceV2HttpsClient.WCFService.Document[]> SearchDocumentsAsync(string Filter);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDocumentServiceChannel : WCFDocServiceV2HttpsClient.WCFService.IDocumentService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DocumentServiceClient : System.ServiceModel.ClientBase<WCFDocServiceV2HttpsClient.WCFService.IDocumentService>, WCFDocServiceV2HttpsClient.WCFService.IDocumentService {
        ...
        public WCFDocServiceV2HttpsClient.WCFService.Document[] GetDocuments() {
            return base.Channel.GetDocuments();
        }
        
        public System.Threading.Tasks.Task<WCFDocServiceV2HttpsClient.WCFService.Document[]> GetDocumentsAsync() {
            return base.Channel.GetDocumentsAsync();
        }
        
        public WCFDocServiceV2HttpsClient.WCFService.Document GetDocument(int DocId) {
            return base.Channel.GetDocument(DocId);
        }
        
        public System.Threading.Tasks.Task<WCFDocServiceV2HttpsClient.WCFService.Document> GetDocumentAsync(int DocId) {
            return base.Channel.GetDocumentAsync(DocId);
        }
        
        public WCFDocServiceV2HttpsClient.WCFService.Document[] SearchDocuments(string Filter) {
            return base.Channel.SearchDocuments(Filter);
        }
        
        public System.Threading.Tasks.Task<WCFDocServiceV2HttpsClient.WCFService.Document[]> SearchDocumentsAsync(string Filter) {
